...
$connection = new mysqli($localhot , $user  , $password , $database);
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        do {
            if(empty($id) || empty($titre) ||  empty($image) ||  empty($description) ||  empty($superficie)  || empty( $adresse) || empty($montant) || empty($type_annonce)) {
                $errorMessage = "All the fields are required";
                break ;
            }

            $sql = "UPDATE annonce " .
                    "SET titre = '$titre' , image = 'img/$image' , description = '$description' , superficie = '$superficie' , adresse = '$adresse' , montant = '$montant' , type_annonce = '$type_annonce'" .
                    "WHERE id = $id";
    ...
    <div class="container my-5">
        ...
        <input type="hidden" name="id" value="<?php echo $id; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <textarea name="description" value="<?php echo $description; ?>" class="form-control" id="" cols="30" rows="10"></textarea>                
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">superficie</label>
                <div class="col-sm-6">
                    <input type="text" name="superficie" value="<?php echo $superficie; ?>" class="form-control" id="">
                </div>
            </div>
